...
urlpatterns = [
    ...
    path("operations/failed/", views.failed_operations_view, name="failed-operatiosn"),
    ...
    path("<int:site_id>/nginx/regenerate-config", views.regen_nginx_config_view, name="regen_nginx_config"),
